...
def consolidate_columns(df):
    """
    Cleans headers and merges columns based on exact user requirements.
    Prevents duplicates like 'Emp ID' vs 'Emp  ID'.
    """
    # Clean headers: handle extra spaces and double spaces
