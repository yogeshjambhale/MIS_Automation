...
def consolidate_columns(df):
    ...
    Fixes duplicates to prevent ValueError.
    """
    # Clean headers to remove hidden spaces/double spaces
    df.columns = df.columns.str.strip().str.replace(r'\s+', ' ', regex=True)
    
    # Handle physical duplicates in the CSV
